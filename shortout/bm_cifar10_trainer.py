...
train_dl = torch.utils.data.DataLoader(cifar_train, batch_size=32, shuffle=True)
test_dl = torch.utils.data.DataLoader(cifar_test, batch_size=32, shuffle=False)
...
logname = "bm_trainlog_" + timestr + ".csv"
with open(logname, 'r') as f:
	writer = csv.writer(f)
	writer.writerows(log)

# save model out
modelname = "bm_weights_" + timestr + ".csv"
