...
if __name__ == "__main__":
    ...
    with open("vgg16/fc6.csv", 'w') as f:
        wr = csv.writer(f)
        wr.writerows(fc6_out)

    with open("vgg16/fc6relu.csv", 'w') as f:
        wr = csv.writer(f)
        wr.writerows(fc6relu_out)

    with open("vgg16/fc7.csv", 'w') as f:
        wr = csv.writer(f)
        wr.writerows(fc7_out)

    with open("vgg16/fc7relu.csv", 'w') as f:
        wr = csv.writer(f)
        wr.writerows(fc7relu_out)

    with open("vgg16/fc8.csv", 'w') as f:
        wr = csv.writer(f)
